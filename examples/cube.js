var cube = [
  new VM.MatrixEl('div').css({width: '100px', height: '100px', 'background-color': 'rgba(0,0,0,1.0)', 'position': 'absolute', 'top': '0', 'left': '0'}),
  new VM.MatrixEl('div').css({width: '100px', height: '100px', 'background-color': 'rgba(255,0,0,1.0)', 'position': 'absolute', 'top': '0', 'left': '0'}),
  new VM.MatrixEl('div').css({width: '100px', height: '100px', 'background-color': 'rgba(0,255,0,1.0)', 'position': 'absolute', 'top': '0', 'left': '0'}),
  new VM.MatrixEl('div').css({width: '100px', height: '100px', 'background-color': 'rgba(0,0,0,255, 1.0)', 'position': 'absolute', 'top': '0', 'left': '0'}),
...
function rotaCube () {
  ...
  cube[0].animate(1, 1, 90, 0, 0, 0, -50, -10);
  cube[1].animate(1, 1, 90, 0, 0, 0, -50, 10);
  cube[2].animate(1, 1, 90, 0, 0, 0, 50, 10);
  cube[3].animate(1, 1, 90, 0, 0, 0, 50, -10);
  cube[4].animate(1, 1, 90, 0, 0, 0, 0, 0);
  cube[5].animate(1, 1, 90, 0, 0, 0, 0, 0);
}
